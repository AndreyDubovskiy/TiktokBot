...
class StatisticObj:
    ...
    async def get_file_name_and_count_statistic(self, start: datetime.datetime, end: datetime.datetime, user_id: str, by:str = "day", filtr:str = None):
        Y = []
        X = []
        total = 0
        list_event = await db.get_events_by_datetime(start, end, filtr)
        count = 0
        current = start
